    ...
    <div className="font-plus pb-32 h-full overflow-y-auto bg-white text-dark-blue">
      ...
      <main className="p-8 space-y-12">
        ...
        <div className="space-y-6">
          ...
          <button onClick={logout} className="w-full py-6 text-sos-red font-black flex items-center justify-center gap-3 bg-red-50 rounded-3xl border border-red-100 active:scale-95 transition-all">
