...
const TripSummaryPage: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full font-plus flex flex-col bg-white overflow-y-auto text-secondary custom-scrollbar pb-[150px]">
      ...
      <div className="mt-[30px] text-center shrink-0 overflow-visible">
        ...
        <h1 className="text-4xl font-black tracking-tighter text-primary">Cuidapp+</h1>
      </div>
      ...
      <main className="p-8 space-y-10 flex-1">
        ...
        <section className="bg-slate-50 rounded-[2.5rem] p-10 border border-slate-100 shadow-sm text-center space-y-8">
          <div className="space-y-2">
            <h2 className="text-[11px] font-black text-secondary tracking-[0.3em]">Estado biométrico promediado</h2>
        ...
        <section className="bg-primary/5 border border-primary/10 p-8 rounded-[2.5rem] shadow-sm flex flex-col gap-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-secondary leading-none tracking-wide">Resumen del servicio</h3>
          </div>
        ...
        <div className="space-y-4 pt-4">
          ...
          <button
            ...
            className="w-full py-4 text-slate-400 font-bold text-sm tracking-wide active:scale-95 transition-all"
          >
