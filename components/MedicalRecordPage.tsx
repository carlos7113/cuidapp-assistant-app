...
const MedicalRecordPage: React.FC = () => {
 ...
 if (isLoading) {
 return (
 <div className="h-screen bg-white flex items-center justify-center pb-[160px]">
 ...
 if (!record) {
 return (
 <div className="h-screen bg-white flex flex-col items-center justify-center p-8 text-center space-y-6 pb-[160px]">
 ...
 return (
 <div className="font-plus min-h-screen bg-white flex flex-col overflow-y-auto text-secondary custom-scrollbar relative pb-[160px]">
 <Header
 ...
 <p className="text-primary/50 font-black text-[10px] tracking-widest mt-2 italic shadow-sm bg-primary/5 px-3 py-1 rounded-full inline-block">Plan Corporativo Activado</p>
 </div>
 ...
 <h3 className="text-sm font-black italic text-slate-400 tracking-[0.3em]">Módulo clínico</h3>
 ...
 <p className="text-[10px] font-black italic text-slate-400 mb-2">Tipo de sangre</p>
 <p className="text-4xl font-black text-secondary leading-none">{record.bloodType}</p>
 </div>
 <div className="bg-slate-50 p-6 rounded-[2.5rem] border border-slate-100 flex flex-col items-center text-center">
 <p className="text-[10px] font-black italic text-slate-400 mb-2">Alergias</p>
 <p className="text-base font-black text-secondary leading-tight truncate w-full px-2">
 ...
 <section className="space-y-6">
 <h3 className="text-sm font-black italic text-slate-400 tracking-[0.3em] ml-2">Requerimientos de movilidad</h3>
 ...
 <section className="space-y-6">
 <h3 className="text-sm font-black italic text-slate-400 tracking-[0.3em] ml-2">Seguro médico</h3>
 ...
 <p className="text-[11px] font-black text-slate-400 mt-2 tracking-[0.2em] leading-none">Póliza: {record.insurancePolicy || 'S/N'}</p>
 </div>
 </div>
 </section>
 )}
 ...
 {/* Medicamentos */}
 <section className="space-y-6">
 <h3 className="text-sm font-black italic text-slate-400 tracking-[0.3em] ml-2">Medicamentos habituales</h3>
 ...
 <h3 className="text-sm font-black italic text-slate-400 tracking-[0.3em]">Equipo de apoyo activo</h3>
 ...
 <div>
 <p className="text-[9px] font-black text-slate-400 leading-none mb-1">{record.emergencyContact.relationship}</p>
 ...
 <div>
 <p className="text-[9px] font-black text-slate-400 leading-none mb-1">{record.emergencyContact2.relationship}</p>
 ...
 <div>
 <p className="text-[9px] font-black text-slate-400 leading-none mb-1">Médico de cabecera</p>
 ...
 <section className="space-y-6">
 <h3 className="text-sm font-black italic text-slate-400 tracking-[0.3em] ml-2">Historial documentado</h3>
 ...
 <button className="size-12 rounded-xl bg-secondary text-white flex items-center justify-center active:scale-90 transition-all italic font-bold">
