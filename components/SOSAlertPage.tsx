...
const SOSAlertPage: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full bg-white font-display flex flex-col overflow-hidden relative">
      ...
      <main className="flex-1 overflow-y-auto px-6 pb-48 text-center">
        ...
        <div className="my-10 space-y-6">
          ...
          <div className="text-left space-y-4 pb-20">
            <h3 className="text-xs font-bold text-slate-400 ml-2">Contactos notificados</h3>
