    ...
    <div className="font-plus bg-white min-h-screen pb-32">
      <header className="px-6 py-8 bg-white border-b border-slate-50 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-secondary leading-none">Ganancias</h1>
      ...
      <main className="p-6 space-y-8">
        <section className="bg-secondary p-8 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex gap-4 mt-8">
              <div className="bg-white/10 px-4 py-2 rounded-xl text-[9px] font-black uppercase">{earnings.history.length} servicios</div>
              <div className="bg-white/10 px-4 py-2 rounded-xl text-[9px] font-black uppercase">Protección senior activa</div>
            </div>
          </div>
        ...
        <section className="bg-slate-50 rounded-[2.5rem] p-8 border border-slate-100">
           <p className="text-[10px] font-black text-slate-400 uppercase mb-6">Actividad semanal</p>
        ...
        <button className="w-full py-5 border-2 border-dashed border-slate-100 rounded-2xl flex items-center justify-center gap-3 text-slate-300 font-bold text-[11px] hover:border-secondary hover:text-secondary transition-all">
