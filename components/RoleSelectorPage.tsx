  ...
  return (
    <div className="h-screen w-full bg-white font-plus flex flex-col p-8 items-center justify-center text-center overflow-hidden relative">
      ...
      <div className="mb-14 relative z-10">
        ...
        <p className="text-slate-500 font-bold text-base leading-tight max-w-[260px] mx-auto">
      ...
      <div className="w-full space-y-4 max-w-sm relative z-10">
        <button 
          ...
          className="w-full bg-[#6C5CE7] text-white p-7 rounded-[2.5rem] shadow-xl shadow-primary/10 active:scale-[0.97] transition-all group text-left flex items-center gap-5 border-none"
        >
          ...
          <div className="flex flex-col justify-center">
            <p className="text-[20px] font-black leading-none italic tracking-tight mb-1">Usuario</p>
        ...
        <button 
          ...
          className="w-full bg-[#A29BFE] text-white p-7 rounded-[2.5rem] shadow-xl shadow-indigo-500/10 active:scale-[0.97] transition-all group text-left flex items-center gap-5 border-none"
        >
          <div className="size-14 bg-white/20 rounded-2xl flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform">
            <span className="material-symbols-outlined text-3xl font-bold">family_restroom</span>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-[20px] font-black leading-none italic tracking-tight mb-1">Familiar responsable</p>
        ...
        <button 
          ...
          className="w-full bg-[#0052CC] text-white p-7 rounded-[2.5rem] shadow-xl shadow-secondary/10 active:scale-[0.97] transition-all group text-left flex items-center gap-5 border-none"
        >
          <div className="size-14 bg-white/20 rounded-2xl flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform">
            <span className="material-symbols-outlined text-3xl font-bold">local_taxi</span>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-[20px] font-black leading-none italic tracking-tight mb-1">Asistente de movilidad</p>
