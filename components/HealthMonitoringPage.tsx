...
const HealthMonitoringPage: React.FC = () => {
 ...
 return (
 <div className="font-plus min-h-screen bg-white relative overflow-x-hidden pb-[160px]">
 ...
 <h2 className="text-white text-5xl font-black tracking-tighter leading-none italic font-bold">
 ¡CAÍDA DETECTADA!
 </h2>
 <p className="text-white/90 text-sm font-black tracking-[0.3em] bg-secondary/20 px-4 py-2 rounded-full inline-block">
 ...
 <div className="text-white text-[12rem] font-black leading-none drop-shadow-[0_10px_30px_rgba(0,0,0,0.3)] tabular-nums">
 {fallCountdown}
 </div>
 ...
 className="w-full bg-white text-sos-red py-8 rounded-[2.5rem] font-black text-2xl shadow-2xl active:scale-95 transition-all border-4 border-white/50 italic font-bold"
 >
 ESTOY BIEN (CANCELAR)
 </button>
 <div className="flex items-center justify-center gap-3 text-white/40">
 <span className="material-symbols-outlined animate-spin text-sm">refresh</span>
 <p className="text-[10px] font-black tracking-[0.4em]">Protocolo Cuidapp+ Nivel 1</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h1 className="text-xl font-black italic tracking-tight text-text-main">Mi Salud</h1>
 ...
 <h2 className="text-[10px] font-black italic text-slate-400 tracking-[0.4em]">Sensores Wearable</h2>
 ...
 <div>
 <p className="text-[9px] font-black text-slate-400 mb-0.5">{stat.label}</p>
 <p className="text-3xl font-black text-text-main leading-none">{stat.value}<span className="text-xs font-bold text-slate-300 ml-1 ">{stat.unit}</span></p>
 </div>
 </div>
 ...
 <p className="text-[10px] font-black italic text-slate-400 mb-6">Actividad Cardiovascular</p>
 ...
 className="w-full bg-white border-2 border-sos-red text-sos-red py-8 rounded-[2rem] flex flex-col items-center justify-center gap-3 shadow-xl active:scale-95 transition-all group italic font-bold"
 >
 <div className="flex items-center gap-3">
 <span className="material-symbols-outlined text-4xl font-black animate-bounce">falling</span>
 <span className="text-2xl font-black italic tracking-tighter">🧪 TEST: SIMULAR CAÍDA</span>
 </div>
 <p className="text-[10px] font-bold italic text-sos-red/60 tracking-[0.3em]">Validación de Sensores de Impacto</p>
 </button>
 </section>
 </main>
