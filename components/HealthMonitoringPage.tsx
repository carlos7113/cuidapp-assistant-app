          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-10 w-full">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-white/90 text-sm font-black uppercase tracking-[0.3em] bg-secondary/20 px-4 py-2 rounded-full inline-block">
            ...
            <div className="w-full space-y-6">
              <button
                ...
                className="w-full bg-white text-sos-red py-8 rounded-[2.5rem] font-black text-2xl shadow-2xl active:scale-95 transition-all border-4 border-white/50 uppercase"
              >
                ESTOY BIEN (CANCELAR)
              </button>
      ...
      <main className="p-6 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-[10px] font-black italic text-slate-400 uppercase tracking-[0.4em]">Sensores Wearable</h2>
            <div className="flex items-center gap-1 text-green-500 font-black">
              <span className="size-2 bg-green-500 rounded-full animate-pulse"></span>
              <span className="text-[10px] uppercase">En Vivo</span>
            </div>
          </div>
            ...
            {stats.map((stat, i) => (
              <div key={i} className="bg-white rounded-[2rem] p-6 shadow-sm border border-slate-50 flex items-center justify-between group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[9px] font-black uppercase text-slate-400 mb-0.5">{stat.label}</p>
                    <p className="text-3xl font-black text-text-main leading-none">{stat.value}<span className="text-xs font-bold text-slate-300 ml-1 uppercase">{stat.unit}</span></p>
                  </div>
                </div>
        ...
        <section className="bg-slate-50 rounded-[2.5rem] p-8 border border-slate-100">
          <p className="text-[10px] font-black italic uppercase text-slate-400 mb-6">Actividad Cardiovascular</p>
        ...
        <section className="pt-4">
          ...
          >
            ...
            <p className="text-[10px] font-bold italic text-sos-red/60 uppercase tracking-[0.3em]">Validación de Sensores de Impacto</p>
          </button>
        </section>
      </main>
