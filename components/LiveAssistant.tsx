...
const LiveAssistant: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-white text-slate-900 font-plus p-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-white/95 backdrop-blur-md z-50 p-8 flex flex-col animate-in fade-in zoom-in duration-300">
           ...
           <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 flex items-center justify-between shadow-sm">
              <div className="flex flex-col gap-1">
                <p className="font-bold text-lg text-slate-900">Asistencia Automática</p>
           ...
           <p className="mt-auto text-center text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em]">Cuidapp+ v2.0</p>
        </div>
      )}
      ...
      <footer className="pb-16 flex justify-center px-6 relative z-10">
        {!isActive ? (
          <button 
            ...
            className="w-full h-24 bg-primary text-white rounded-[2.5rem] font-black text-2xl flex items-center justify-center gap-5 shadow-2xl shadow-primary/30 active:scale-95 transition-all border-4 border-white"
          >
            {isConnecting ? (
          ...
          <button 
            onClick={stopSession}
            className="w-28 h-28 bg-sos-red text-white rounded-full shadow-2xl shadow-sos-red/20 flex items-center justify-center border-4 border-white active:scale-95 transition-all animate-pulse"
          >
