  ...
  return (
    <div className="min-h-screen bg-white font-plus flex flex-col pb-[180px] overflow-y-auto custom-scrollbar">
      <header className="p-8 pb-4">
        ...
        <h1 className="text-4xl font-black tracking-tighter text-secondary leading-tight">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h3 className="text-2xl font-black text-primary leading-none">{plan.name}</h3>
              ...
              <div className="text-right">
                ...
                <p className="text-[10px] font-black text-secondary/30 uppercase mt-1">usd / mes</p>
              </div>
            </div>
