...
const ActiveTripPage: React.FC = () => {
 ...
 return (
 <div className="h-screen w-full font-plus flex flex-col bg-white overflow-hidden text-secondary pb-[160px]">
 {/* Encabezado Cuidapp+ */}
 ...
 <h2 className="text-[11px] font-bold text-primary italic font-bold">
 ...
 <button className="flex flex-col items-center justify-center gap-2 bg-white border-2 border-slate-50 py-6 rounded-[2rem] shadow-md active:scale-95 transition-all group italic font-bold">
 ...
 className="w-full bg-primary text-white py-8 rounded-[2.5rem] font-black text-xl shadow-2xl shadow-primary/30 active:scale-95 transition-all border-4 border-white/20 tracking-[0.04em] italic font-bold"
 >
 Ya subí al vehículo
 </button>
 <button
 onClick={handleCancelTrip}
 className="w-full py-4 text-slate-400 font-bold text-sm active:scale-95 transition-all italic font-bold"
 >
 Cancelar viaje
 </button>
 </div>
